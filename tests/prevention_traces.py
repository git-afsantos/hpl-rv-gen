...
def globally_forbids_within():
    ...
    traces.append([
        ...
        new_spam('b', p2d()),
        new_spam('b', p2d()),
        new_spam('b', p2d(x=1), state=STATE_SAFE),
        new_spam('b', p2d(x=1)),
    ])
    # invalid
    traces.append([
...
def globally_forbids_ref_within():
    ...
    traces.append([
        ...
        new_spam('b', p2d(x=2)),
        new_spam('b', p2d(x=2)),
        new_spam('b', p2d(x=2), state=STATE_SAFE),
        new_trigger(p2d(x=1), STATE_ACTIVE),
        new_behaviour(p2d(x=2), STATE_FALSE),
        new_spam('b', p2d(x=3)),
    ])
...
def after_forbids():
    ...
    traces.append([ new_timer() ])
    traces.append([ new_spam('b', p2d(x=1)) ])
    traces.append([ new_spam('a', p2d(x=1)) ])
...
def after_forbids_ref_within():
    ...
    traces.append([
        ...
        new_spam('b', p2d(x=3)),
        new_timer(),
        new_spam('b', p2d(x=3), state=STATE_SAFE),
        new_spam('b', p2d(x=4)),
    ])
    # invalid
    traces.append([
...
def until_forbids_within():
    ...
    traces.append([
        ...
        new_spam('a', p2d(x=0)),
        new_spam('b', p2d(x=0)),
        new_spam('b', p2d(x=0), state=STATE_SAFE),
        new_trigger(p2d(x=1), STATE_ACTIVE),
        new_spam('a', p2d(x=0)),
        new_spam('b', p2d(x=0)),
        new_spam('b', p2d(x=0), state=STATE_SAFE),
...
def until_forbids_ref_within():
    ...
    traces.append([
        new_trigger(p2d(x=1), STATE_ACTIVE),
        new_terminator(p2d(x=2), STATE_TRUE),
    ])
    traces.append([
        new_trigger(p2d(x=2), STATE_ACTIVE),
        new_trigger(p2d(x=1), None),
        new_spam('b', p2d(x=1), None),
        new_spam('b', p2d(x=1), None),
        new_spam('b', p2d(x=3), state=STATE_SAFE),
        new_terminator(p2d(x=1), STATE_TRUE),
    ])
...
def after_until_forbids_ref_within():
    ...
    traces.append([
        ...
        new_spam('b', p2d(x=2)),
        new_spam('b', p2d(x=3)),
        new_spam('b', p2d(x=4), state=STATE_SAFE),
        new_trigger(p2d(x=2), STATE_ACTIVE),
        new_trigger(p2d(x=3), None),
        new_spam('b', p2d(x=2)),
        new_spam('b', p2d(x=3)),
